...
public class Principal extends javax.swing.JFrame {
    ArrayList<Departamento> ListaDep;//minha lista de departamentos
    ArrayList<Funcionario> ListaFunc;//minha lista de funcionarios
    String modoDep;
    String modoFunc;
    ...
    public void LoadTableDep(){
        ...
        LoadCBDep();//atualizar no departamento também 
    }
     ...
     */
    //quando se inicia a aplicação chamar os métodos de manipulação 
    public Principal() {
        initComponents();
    ...
    //Função para manipular a interface dados de departamentos
    ...
    //Manipulação de dados para o funcionario
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btn_dep_excluir, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btn_func_excluir, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void btn_dep_novoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_dep_novoActionPerformed
        ...
        c_dep_nome.setText("");
        //chamar o manipula interface chamando o novo
        modoDep = "Novo";
        ManipulaInterfaceDep();
    ...
    private void btn_dep_cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_dep_cancelarActionPerformed
        c_dep_codigo.setText("");
        c_dep_nome.setText("");
        //chamar o manipula interface chamando o navegação
        modoDep = "Navegar";
        ManipulaInterfaceDep();
    ...
    private void btn_func_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_func_salvarActionPerformed
    	 //criar o funcionario,  seta o departamento e adicionar o funcionario na lista de departamentos 
        ...
        if(index==0){
            ...
            ListaFunc.add(F);//adicionando o funcionario nas duas listas
